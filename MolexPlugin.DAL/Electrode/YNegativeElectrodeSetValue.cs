...
namespace MolexPlugin.DAL
{
    ...
    /// Z+向加工
    /// </summary>
    public class YNegativeElectrodeSetValue : AbstractElectrodeSetValue
    {
        public YNegativeElectrodeSetValue(ElectrodeHeadInfo head) : base(head)
        {
        }
